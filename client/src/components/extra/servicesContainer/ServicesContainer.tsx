...
const ServicesContainer = () => {
    ...
    return <Box className={'max-w-[1200px] p-2 flex gap-4 m-auto justify-around my-5'}>
        <ServiceCard icon={<TbTruckDelivery className="w-12 my-2 h-12 font-light m-auto text-primary-main" />} title={"Free Shipping"} subtitle={"Free shipping on all US order or order above $200"} />

...
import BalanceCard from '../../../extra/balanceCard';

const MakeRefillComponent = () => {
      ...
      <Grid container className="justify-center items-center p-4 gap-y-2">
        ...
        <Grid item xs={12}>
          <TextField
            ...
            helperText={
              formData.amount > 50 ? '' : 'Amount should be greater than 50MAD'
            }
            inputProps={{ min: 50 }}
            required
            sx={{
...
export default MakeRefillComponent;

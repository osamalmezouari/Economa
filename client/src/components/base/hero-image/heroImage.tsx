...
const HeroImage = () => {
    return <>
        <Box className={'rounded bg-cover mt-10 bg-center max-w-[1300px] h-[600px] m-auto grid grid-cols-2  p-4 sm:px-24 sm:pt-4'} component={'div'} style={{ backgroundImage: `url(${Image_bg_hero.src})` }} >

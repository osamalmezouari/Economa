...
const HeroImage = () => {
    return <>
        <Box className={'rounded bg-cover mt-10 bg-center max-w-[1400px] h-[600px] m-auto grid grid-cols-2 grid-rows-3 p-24'} component={'div'} style={{ backgroundImage: `url(${Image_bg_hero.src})` }} >

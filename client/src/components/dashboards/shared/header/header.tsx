...
const Header = () => {
  ...
  return (
    <Box
      className={
        'sticky flex justify-between px-8 py-8 bg-gray-0/80 z-50 w-full h-20 bg-opacity-20 items-center shadow backdrop-blur-xl'
      }
    >
      <Box className={'w-3/12 hover:pt-[1px]'}>
        <button
      ...
      <Box className={'flex items-center gap-5'}>
        ...
        <IconButton className="group !rounded !bg-white !drop-shadow-sm">
          ...
          >
            <ScanQrCode className="h-[20px] text-black w-auto group-hover:text-primary-main transition-all" />
          </Badge>
        </IconButton>
